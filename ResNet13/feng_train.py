...
class ResNet_train():
    def __init__(self, image_size, num_epoch, batch_size, learning_rate,
                 weight_decay, num_classes, train_file, val_file, filewriter_path, checkpoint_path,
        ...
        self.x = tf.placeholder(tf.float32, [None, self.image_size, self.image_size, 3], name='input')
    ...
    def fit(self):
        ...
        train_generator = ImageDataGenerator(self.train_file, scale_size=(self.image_size, self.image_size),
                                             nb_classes=self.num_classes)
        val_generator = ImageDataGenerator(self.val_file, scale_size=(self.image_size, self.image_size),
                                           nb_classes=self.num_classes)
