...
train_path = "dataset/mnist_pic_new/train"
test_path = "dataset/mnist_pic_new/test"

if not os.path.exists("./path/minist"):
    os.makedirs("./path/minist")

train_txt = "./path//minist/train.txt"
test_txt = "./path//minist/valid.txt"
