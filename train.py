...
# Initalize the data generator seperately for the training and validation set
# train_generator = ImageDataGenerator(train_file, target_file, scale_size=(image_size, image_size), nb_classes=num_classes)
# val_generator = ImageDataGenerator(val_file, target_file, scale_size=(image_size, image_size), nb_classes=num_classes)
